...
@WebServlet("/chap5-1")
public class EmailListServletChap5_1 extends HttpServlet {

    @Override
    protected void doPost(HttpServletRequest request,
            HttpServletResponse response)
            throws ServletException, IOException {
        String url = "/jspFile/jspChap5/chap5_1.jsp";
        ...
        if (action.equals("join")) {
            url = "/jspFile/jspChap5/chap5_1.jsp";    // the "join" page
        } 
            ...
            if (firstName == null || lastName == null || email == null ||
                ...
                url = "/jspFile/jspChap5/chap5_1.jsp";
            } 
            else {
                message = "";
